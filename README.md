...
In fact, even the **HTML to Markdown** converter was not written by me, and the whole converting process takes up only **±150 lines of code** (with comments !)
...
```bash
pip install --upgrade pip rich markdown python-dateutil
```
